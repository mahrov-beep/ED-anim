namespace Multicast.Notifications {
    ...
    /// </remarks>
    internal struct GameNotificationChannel {
        /// <summary>
        ...
        public GameNotificationChannel(string id, string name, string description) : this() {
            ...
            this.ShowsBadge       = true;
            this.ShowLights       = false;
            this.Vibrates         = true;
            this.HighPriority     = false;
            this.Style            = NotificationStyle.Popup;
            this.Privacy          = PrivacyMode.Public;
        ...
        /// </summary>
        public GameNotificationChannel(string id, string name, string description, NotificationStyle style, bool showsBadge = true, bool showLights = false, bool vibrates = true,
            bool highPriority = false, PrivacyMode privacy = PrivacyMode.Public, long[] vibrationPattern = null) {
            this.Id           = id;
            this.Name         = name;
            this.Description  = description;
            this.ShowsBadge   = showsBadge;
            ...
            if (vibrationPattern != null)
                this.VibrationPattern = vibrationPattern.Select(v => (int) v).ToArray();
            else
                this.VibrationPattern = null;
        }
    }
