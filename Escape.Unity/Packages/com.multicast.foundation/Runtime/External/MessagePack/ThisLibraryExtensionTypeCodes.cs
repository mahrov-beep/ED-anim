namespace Multicast.External.MessagePack {
    /// <summary>
    ...
    internal static class ThisLibraryExtensionTypeCodes {
        /// <summary>For Unity's UnsafeBlitFormatter.</summary>
        ...
        /// <summary>The LZ4 array block compression extension.</summary>
        internal const sbyte Lz4BlockArray = 98;
        /// <summary>The LZ4 single block compression extension.</summary>
