namespace Multicast.AssetProcessors.EnforcePresets {
    using System.IO;
    using System.Linq;
    using UnityEditor;
    ...
    public class EnforcePresetPostProcessor : AssetPostprocessor {
        ...
        private void OnPreprocessAsset() {
            ...
            if (this.assetPath.StartsWith("Assets/") &&
                !AssetDatabase.IsValidFolder(this.assetPath) &&
                !this.assetPath.EndsWith(".cs") &&
                !this.assetPath.EndsWith(".preset")) {
                var path = Path.GetDirectoryName(this.assetPath);
                this.ApplyPresetsFromFolderRecursively(path);
            }
        }
        ...
        private void ApplyPresetsFromFolderRecursively(string folder) {
            ...
            if (!string.IsNullOrEmpty(parentFolder)) {
                this.ApplyPresetsFromFolderRecursively(parentFolder);
            }
            ...
            foreach (var presetPath in presetPaths) {
                ...
                if (preset == null || preset.ApplyTo(this.assetImporter)) {
