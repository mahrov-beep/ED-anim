namespace Multicast.EditorTools {
    ...
    public class ScriptableObjectCreatorMenu : OdinMenuEditorWindow {
        private static readonly HashSet<Type> ScriptableObjectTypes = new HashSet<Type>(AssemblyUtilities.GetTypes(AssemblyCategory.Scripts | AssemblyCategory.ImportedAssemblies)
            .Where(t =>
                t.IsClass &&
                !t.IsAbstract &&
