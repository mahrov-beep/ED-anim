namespace Quantum
{
	...
	public unsafe class EnvironmentProcessor : KCCProcessor, IBeforeMove, IAfterMoveStep
	{
		...
		public void BeforeMove(KCCContext context, KCCProcessorInfo processorInfo)
		{
			...
			SetKinematicVelocity(context, ref context.KCC->Data, context.KCC->Data.KinematicSpeed/*KinematicSpeed*/, KinematicGroundAcceleration, KinematicAirAcceleration, KinematicGroundFriction, KinematicAirFriction);
		}
