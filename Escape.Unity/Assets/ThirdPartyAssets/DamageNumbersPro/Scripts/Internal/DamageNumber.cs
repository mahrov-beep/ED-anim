...
namespace DamageNumbersPro
{
    ...
    public abstract class DamageNumber : MonoBehaviour
    {
        ...
        protected List<Mesh> meshs = new();
        protected List<Color[]> colors = new();
        protected List<float[]> alphas = new();
        ...
        */
        ...
        public void UpdateText()
        {
            ...
            //Get Colors:
            colors /* = new List<Color[]>() */ .Clear();
            alphas /* = new List<float[]>() */ .Clear();
            ...
            for (int n = 0; n < meshs.Count; n++)
            {
                ...
                {
                    colors.Add(Array.Empty<Color>());
                    alphas.Add(Array.Empty<float>());
                }
            }
