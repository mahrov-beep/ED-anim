...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class OffsetMotion : Motion
    {
        ...
        public override void Tick()
        {
            ...
            if (feelManager == null || characterBehaviour == null || characterAnimator == null)
            {
                //ReferenceError.
            ...
            WeaponBehaviour weaponBehaviour = this.characterBehaviour.GetInventory().GetEquipped();
            ...
            ItemOffsets itemOffsets = itemAnimationDataBehaviour.GetItemOffsets(this.characterBehaviour.GetCharacterType());
            if (itemOffsets == null)
                return;
            ...
            if (itemOffsets.EnableReloadingOffset && this.characterBehaviour.IsReloading()) {
                location += itemOffsets.ReloadingLocation;
                rotation += itemOffsets.ReloadingRotation;
            } else if (itemOffsets.EnableRollOffset && this.characterBehaviour.GetFullBodyState() == CharacterFullBodyStates.Roll) {
                location += itemOffsets.RollLocation;
                rotation += itemOffsets.RollRotation;
            }
