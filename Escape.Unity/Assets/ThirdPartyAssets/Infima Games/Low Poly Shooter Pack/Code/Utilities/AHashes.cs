...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public static class AHashes
    {
        ...
        /// <summary>
        /// Hashed "Full Body State".
        /// </summary>
        public static readonly int FUllBodyState = Animator.StringToHash("Full Body State");

        /// <summary>
        /// Hashed "Foot IK".
        /// </summary>
        public static readonly int FootIk = Animator.StringToHash("Foot IK");

        /// <summary>
        /// Healing toggle for upper-body animation.
        /// </summary>
