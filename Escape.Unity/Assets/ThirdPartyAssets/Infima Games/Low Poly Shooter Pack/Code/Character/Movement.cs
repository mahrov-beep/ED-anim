...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Movement : MovementBehaviour
    {
        ...
        protected override void Update()
        {
            ...
            equippedWeapon = character.GetInventory().GetEquipped();
        ...
        {
            //Get Movement Input!
            Vector2 frameInput = Vector3.ClampMagnitude(character.GetInputMovement(), 1.0f);
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        var config = this.character.GetConfig();
                        ...
                        desiredDirection.x *= config.walkingMultiplierSideways;
                        //Multiply by the forwards and backwards multiplier.
                        desiredDirection.z *=
                            (frameInput.y > 0 ? config.walkingMultiplierForward : config.walkingMultiplierBackwards);
                    }
                }
            } 
