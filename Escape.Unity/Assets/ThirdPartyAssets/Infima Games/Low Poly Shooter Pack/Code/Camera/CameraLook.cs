...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class CameraLook : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            rotationCharacter = playerTransform.localRotation;
            //Cache the camera's initial rotation.
            rotationCamera = cameraTransform.localRotation;
        }
        /// <summary>
        /// LateUpdate.
        /// </summary>
        private void LateUpdate()
        {
            ...
            if (smooth)
            {
                ...
                playerTransform.rotation = Quaternion.Slerp(playerTransform.rotation, rotationCharacter, Time.deltaTime * interpolationSpeed);
            }
            else
            {
                //Rotate local.
                ...
                //Rotate character.
                playerTransform.rotation *= rotationYaw;
            }
