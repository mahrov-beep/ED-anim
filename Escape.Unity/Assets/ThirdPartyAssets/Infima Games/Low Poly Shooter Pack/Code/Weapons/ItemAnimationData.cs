...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class ItemAnimationData : ItemAnimationDataBehaviour
    {
        ...
        [Tooltip("The object that contains all offset data for this item for local view character.")]
        [SerializeField, InlineEditor]
        private ItemOffsets itemOffsets;

        [Required(InfoMessageType.Warning)]
        [Tooltip("The object that contains all offset data for this item for third person character.")]
        [SerializeField, InlineEditor]
        private ItemOffsets itemOffsetsThirdPerson;
        ...
        /// GetItemOffsets.
        /// </summary>
        public override ItemOffsets GetItemOffsets(CharacterTypes characterType) {
            if (characterType == CharacterTypes.RemotePlayer) {
                return this.itemOffsetsThirdPerson;
            }
