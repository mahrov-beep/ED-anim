...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Laser : LaserBehaviour
    {
        ...
        [SerializeField]
        [ValidateInput(nameof(ValidateLaserTransform))]
        ...
        private bool ValidateLaserTransform(Transform _, ref string error) {
            if (this.laserTransform.parent == this.transform) {
                error = "Laser transform must be parented to empty gameobject that will be scaled at runtime. Current setup is incorrect";
                return false;
            }
        ...
        public override void Toggle()
        {
            ...
            // if(toggleClip != null)
            //     ServiceLocator.Current.Get<IAudioManagerService>().PlayOneShot(toggleClip, this.transform.position, toggleAudioSettings);
        }
        /// <summary>
        /// Reapply.
        /// </summary>
