namespace Game.UI.Widgets.MainMenu {
    ...
    public class MainMenuPlayButtonWidget : StatefulWidget {
    }

    public class MainMenuPlayButtonState : ViewState<MainMenuPlayButtonWidget>, IMainMenuPlayButtonState {
        [Inject] private Domain.Party.PartyModel partyModel;

        public override WidgetViewReference View => UiConstants.Views.MainMenu.PlayButton;
        ...
        public void Play() {
            ...
            GameplayStartFeatureEvents.Start.Raise();
        }
