namespace Game.UI.Widgets {
    ...
    [RequireFieldsInit]
    public class InventoryByNearbyWidget : StatefulWidget {
        public Action            OnClose;
        public IAnimation<float> Animation;
    }

    public class InventoryByNearbyState : HocState<InventoryByNearbyWidget> {
        ...
        public override Widget Build(BuildContext context) {
            var animation = this.Widget.Animation;
